...
function findBestDirection(map, current, destination) {
    // if(current[1] < destination[1] && map[current[1] + 1][current[0]] !== "#") {
    //     return 2;

    // } else if(current[1] < destination[1] && map[current[1] + 1][current[0]] !== "#") {
    //     return 1;

    // } else if(current[0] < destination[0] && map[current[1]][current[0] + 1] !== "#") {
    //     return 4;
    ...
    while (input[current] !== 99) {
        ...
        switch(opcode) {
            ...
            case 3:
                // console.log('\033[2J');
                // print(grid);
                direction = findBestDirection(grid, [x,y], [38,68]);
                direction = direction;
                input[a] = direction;
                current += 2;
                break;
