...
#....#....#................#...`,
    ...
    "day-04": `iyr:1928 cid:150 pid:476113241 eyr:2039 hcl:a5ac0f
ecl:#25f8d2
byr:2027 hgt:190
...
pnjtz`,
    ...
    "day-07": `dotted salmon bags contain 2 dark lavender bags, 1 muted red bag, 1 vibrant magenta bag.
...
144`,
    ...
    "day-11": `LLLLLLLLLL.LLLLLLLL.LLLLLLLLLLLLL.LLLLL.LLLL.LL.L.LLLLLLLLLLLLLLLLLLLLLLLLLL.LLLLLLLLLLLLLL
...
41,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,37,x,x,x,x,x,379,x,x,x,x,x,x,x,23,x,x,x,x,13,x,x,x,17,x,x,x,x,x,x,x,x,x,x,x,29,x,557,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,19`,
    ...
    "day-14": `mask = 110100X1X01011X01X0X000111X00XX1010X
mem[29267] = 4155
mem[6177] = 494929
mem[47500] = 15063410
...
tcpjd vnjxjg ltzdz bfhkjm qjvgh zrcqxd qbxmst ccrbr hdxpf kfqnkld gnfl xlgjn qlpsq ncnzr bdmmnn ddpg gkntmb fmxltts rsjt rmmzt kvhhnx kbml gxg ppqsg gvkcgbb qrdqpnd ghfd tlbk zqrgzc gtpzt bshd zhpn qtrk shb lvtglg rcsrk gjpgp gvpq tdmqcl fgmjgxx tsgb mzqjxq vgzx vzjk slhrk tnhcqg jxdk qstnz jbbsjh gxh czfhm tttc nzzxdj bvmld gvcrp lrrkhsq gmspg cmdfcb vhb qfdh rxdbdq bdlcbg hpkznb fsfxl gcspgn gjgqxt kpvxqt hbrk snksnr cpttmnv dhpqh nlph tdpgb zjpc kdct rlxvs pchkj qrhrmj cpk svgrpz (contains shellfish, sesame)`,
    ...
    "day-24": `neswsewswseswseenwseneswseswswswseswse
